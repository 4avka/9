...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/git.parallelcoin.io/dev/9/util/bloom)
...
```bash
$ go get -u git.parallelcoin.io/dev/9/bloom
```

## Examples

- [NewFilter Example](http://godoc.org/git.parallelcoin.io/dev/9/util/bloom#example-NewFilter)  
