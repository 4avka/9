...
func TestScriptBuilderAddData(
	...
	tests := []struct {
		...
		// BIP0062: Pushing the byte 0x81 must use Op1Negate.
		...
		// BIP0062: Pushing 76 to 255 bytes must use OpPushData1.
		{
		...
		// BIP0062: Pushing 256 to 520 bytes must use OpPushData2.
		{
		...
		// BIP0062: OpPushData4 can never be used, as pushes over 520 bytes are not allowed, and those below can be done using other operators.
		{
