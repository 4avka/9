...
[![GoDoc](http://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/git.parallelcoin.io/dev/9/btcutil/txsort)
...
```bash
$ go get -u git.parallelcoin.io/dev/9/btcutil/txsort
```
