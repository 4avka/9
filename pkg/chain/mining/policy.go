...
func CalcPriority(
	...
	// A compressed pubkey pay-to-script-hash redemption with a maximum len signature is of the form: [OpData73 <73-byte sig> + OpData35 + {OpData33 <33 byte compresed pubkey> + OpCheckSig}]
