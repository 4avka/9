...
[![GoDoc](https://img.shields.io/badge/godoc-reference-blue.svg)](http://godoc.org/git.parallelcoin.io/dev/9/peer)
...
```bash
$ go get -u git.parallelcoin.io/dev/9/peer
```

## Examples

- [New Outbound Peer Example](https://godoc.org/git.parallelcoin.io/dev/9/peer#example-package--NewOutboundPeer)  
