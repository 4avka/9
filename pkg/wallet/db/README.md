...
[![GoDoc](https://godoc.org/git.parallelcoin.io/dev/9/walletmain/walletdb?status.png)]
(http://godoc.org/git.parallelcoin.io/dev/9/walletmain/walletdb)
...
http://localhost:6060/pkg/git.parallelcoin.io/dev/9/walletmain/walletdb
...
* [Basic Usage Example]
  (http://godoc.org/git.parallelcoin.io/dev/9/walletmain/walletdb#example-package--BasicUsage)  
