...
[![GoDoc](https://godoc.org/git.parallelcoin.io/dev/9/walletmain/votingpool?status.png)]
(http://godoc.org/git.parallelcoin.io/dev/9/walletmain/votingpool)
...
http://localhost:6060/pkg/git.parallelcoin.io/dev/9/walletmain/votingpool
