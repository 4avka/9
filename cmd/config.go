...
var Config = Lines{
	...
	"p2p.whitelist":           NetAddrs("", "peers who are never banned"),
	...
	"p2p.externalips":         NetAddrs("", "additional external IP addresses to bind to"),
	...
	"mining.algo":             Algos("random", "select from available mining algorithms"),
