...
var NineApp = func() *App {
	...
	will have its detailed help information printed`),
		...
		Cmd("gui",
			...
			Pattern("^(t|test)$"),
			Short("run multiple full nodes from given <word> logging optionally to <datadir>"),
			Detail(`	<word> indicates the basename to search for as the path to the test configurations
