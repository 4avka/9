...
import (
	...
	"testing"
	"time"
	"git.parallelcoin.io/dev/9/cmd/spv/cache"
	"git.parallelcoin.io/dev/9/cmd/spv/cache/lru"
	"git.parallelcoin.io/dev/9/cmd/spv/filterdb"
	"git.parallelcoin.io/dev/9/cmd/spv/headerfs"
	...
	"git.parallelcoin.io/dev/9/pkg/util/gcs"
