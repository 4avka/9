...
https://git.parallelcoin.io/dev/9/walletmain/releases
...
```
git clone https://git.parallelcoin.io/dev/9/walletmain $GOPATH/src/git.parallelcoin.io/dev/9/walletmain
cd $GOPATH/src/git.parallelcoin.io/dev/9/walletmain
glide install
```
...
```bash
$ cp $GOPATH/src/git.parallelcoin.io/dev/9/sample-pod.conf ~/.pod/pod.conf
$ cp $GOPATH/src/git.parallelcoin.io/dev/9/walletmain/sample-btcwallet.conf ~/.btcwallet/btcwallet.conf
$ $EDITOR ~/.pod/pod.conf
...
The [integrated github issue tracker](https://git.parallelcoin.io/dev/9/walletmain/issues)
